...
launch_one() {
  ...
  log_path="nohup/llama_ca_formal1k_${tag}_gpu${gpu}_${stamp}.log"
...
main() {
  sync_host
  local s16="ca_s16_hide15_act12_r32_p10"
  local s8="ca_s8_hide3_act1_r32_p10"
  local s4="ca_s4_hide15_act12_r32_p10"
  launch_one 0 "ca_s16_hide15_act12|no_compression|$SOURCE/configs/$s16.yaml|$SOURCE/adapters/$s16" s16_no
  launch_one 1 "ca_s16_hide15_act12|target_decoy_prune|$SOURCE/configs/$s16.yaml|$SOURCE/static/$s16/target_decoy_prune/threshold_0.5" s16_target
  launch_one 2 "ca_s8_hide3_act1|no_compression|$SOURCE/configs/$s8.yaml|$SOURCE/adapters/$s8" s8_no
  launch_one 3 "ca_s8_hide3_act1|target_decoy_prune|$SOURCE/configs/$s8.yaml|$SOURCE/static/$s8/target_decoy_prune/threshold_0.5" s8_target
  launch_one 4 "ca_s4_hide15_act12|no_compression|$SOURCE/configs/$s4.yaml|$SOURCE/adapters/$s4" s4_no
  launch_one 5 "ca_s4_hide15_act12|target_decoy_prune|$SOURCE/configs/$s4.yaml|$SOURCE/static/$s4/target_decoy_prune/threshold_0.5" s4_target
}
