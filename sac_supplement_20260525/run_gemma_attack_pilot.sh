...
PACK="${PACK:-outputs/supplement_20260525/gemma3_4b_attack_pilot_20260604}"
TRAIN_MAX_STEPS="${TRAIN_MAX_STEPS:-220}"
...
BASE_CONFIG="configs/lora_config_gemma3_4b_it.yaml"
...
log() {
  printf '[gemma-attack] %s host=%s gpu=%s shard=%s/%s %s\n' \
...
TASK_NAMES=(gemma_vanilla_r32_p10 gemma_cr_mixed_r32_p10)
TASK_MODES=(vanilla cr_mixed)

log "start gemma attack pilot"
